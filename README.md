# Rwalocation
> A package for listing locations in Rwanda 

```
USAGE

1. Import the package and access the modules directly from the package
>>> import rwalocation 
...
2. Import the module from the package and use the module
